...
try:
    ...
    db.execute("CREATE TABLE 'transactions' ('id' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, 'user_id' INTEGER NOT NULL, 'stock_id' INTEGER NOT NULL, 'action' TEXT NOT NULL, 'price' NUMERIC NOT NULL, 'shares' INTEGER NOT NULL, 'time' DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)")
except:
    pass
